...
Cone::Cone(Material* material, const Point& center1, const Point& center2,double radius1, double radius2)
  : Primitive(material), center1(center1), center2(center2),radius1(radius1),radius2(radius2)
{
  Z = (center2 - center1);
  if(radius1>radius2)
  {
...
void Cone::intersect(HitRecord& hit, const RenderContext&, const Ray& ray) const
{
